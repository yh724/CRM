...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#SelectEnsureBtn").click(function () {
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="SelectEnsureBtn">选择</button>
                </div>
            </div>
        </div>
    </div>
...
<div id="create-transaction2"
    ...
    <form action="workbench/clue/convert.do" method="post" id="transForm">
        ...
        <div class="form-group" style="width: 400px;position: relative; left: 20px;">
            <label for="activity">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" id="searchModalBtn" style="text-decoration: none;"><span
