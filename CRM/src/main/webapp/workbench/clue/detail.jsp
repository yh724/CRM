...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#bundModal").on('shown.bs.modal', function (e) {
                $('#bund-keywords').focus();
            });

            $("#bund-keywords").keydown(function (event) {
                if (event.keyCode == 13){
                    getUnbundleActivity();
                    return false;
                }
            ...
            $("#bundleEnsureBtn").click(function () {
                var $xz = $("input[name=xz]:checked");
                var u = "${c.id}&";
                for(var i=0;i<$xz.length;i++){
                    u += "activityId="+$xz[i].id;
                    if(i!=$xz.length-1)
                        u += "&";
                }
                $.ajax({
                    //url=workbench/clue/bundle.do?clueId=xxx%=&activityId=xxx&act...
                    url:"workbench/clue/bundle.do?clueId="+u,
                    dataType:"json",
            ...
            $("#bundleTb").on("click", $("input[name=xz]"), function () {
        ...
        function getUnbundleActivity() {
            $.ajax({
                url: "workbench/clue/getUnbundleActivity.do",
                data: {
                    "id": "${c.id}",
                    "keywords": $("#bund-keywords").val()
                },
                dataType: "json",
                success: function (data) {
                    //data:[{act1},{act2}...]
    ...
    <div class="modal-dialog" role="document" style="width: 80%;">
        <div class="modal-content">
                ...
                <div class="btn-group" style="position: relative; top: 18%; left: 8px;">
                    <form class="form-inline" role="form">
                        <div class="form-group has-feedback">
                            <input id="bund-keywords" type="text" class="form-control" style="width: 300px;"
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="bundleEnsureBtn">关联</button>
            </div>
        </div>
    </div>
</div>
...
<div style="position: relative; left: 40px; top: -30px;">
    ...
    <div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
        <button type="button" class="btn btn-default" onclick="window.location.href='workbench/clue/convert.jsp?clueId=${c.id}&company=${c.company}&fullname=${c.fullname}&appellation=${c.appellation}&owner=${c.owner}';"><span
...
<div>
    <div style="position: relative; top: 60px; left: 40px;">
        ...
        <div>
            <a href="javascript:void(0);" id="bundleBtn"
